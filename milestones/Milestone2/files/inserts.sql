...
INSERT INTO Profile (profile_id, profile_pronouns, profile_picture) VALUES
...
INSERT into Actions (action_id, action_type, action_description) VALUES
(1, 'MAKE APPOINTMENT', 'This action allows the account to make an appointment.'),
(2, 'CHANGE PAYMENT TYPE', 'This action allows the account to change their payment type.'),
(3, 'CHANGE PROFILE', 'This action allows the account to change their profile.');
...
(1, 1, 4, '2021-10-10', '12:30:00', 1, 'THIS IS AFTERCARE NOTES.'),
(2, 2, 5, '2021-10-15', '11:30:00', 1, 'THIS IS AFTERCARE NOTES.'),
(3, 3, 6, '2021-10-20', '10:00:00', 1, 'THIS IS AFTERCARE NOTES.');
-- Date table inserts
